...
export default function Hero() {
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-gray-950">
      ...
      {/* Decorative Blobs */}
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-primary-600/30 blur-[128px] animate-blob mix-blend-screen" />
      <div className="absolute bottom-0 left-20 w-72 h-72 rounded-full bg-green-500/20 blur-[128px] animate-blob animation-delay-2000 mix-blend-screen" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full z-10 animate-fade-in-up">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tight mb-6 max-w-3xl">
          Discover Your <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-primary-400 animate-gradient">
            Perfect Residence
          </span>
          <br />
          in Sierra Leone
