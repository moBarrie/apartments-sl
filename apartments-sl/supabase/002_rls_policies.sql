...
-- ============================================================
DROP POLICY IF EXISTS "Landlords can view own profile" ON landlord_profiles;
CREATE POLICY "Landlords can view own profile" ON landlord_profiles
  FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Landlords can update own profile" ON landlord_profiles;
CREATE POLICY "Landlords can update own profile" ON landlord_profiles
  FOR UPDATE USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Landlords can insert own profile" ON landlord_profiles;
...
-- Apartments policies
-- ============================================================
DROP POLICY IF EXISTS "Anyone can view approved apartments" ON apartments;
CREATE POLICY "Anyone can view approved apartments" ON apartments
  FOR SELECT USING (status = 'APPROVED' OR landlord_id = auth.uid());

DROP POLICY IF EXISTS "Landlords can insert own apartments" ON apartments;
CREATE POLICY "Landlords can insert own apartments" ON apartments
  FOR INSERT WITH CHECK (auth.uid() = landlord_id);

DROP POLICY IF EXISTS "Landlords can update own apartments" ON apartments;
CREATE POLICY "Landlords can update own apartments" ON apartments
  FOR UPDATE USING (auth.uid() = landlord_id);

DROP POLICY IF EXISTS "Landlords can delete own apartments" ON apartments;
...
-- ============================================================
DROP POLICY IF EXISTS "Anyone can view images of approved apartments" ON apartment_images;
...
DROP POLICY IF EXISTS "Landlords can manage own apartment images" ON apartment_images;
...
-- ============================================================
DROP POLICY IF EXISTS "Anyone can view apartment amenities" ON apartment_amenities;
...
DROP POLICY IF EXISTS "Landlords can manage own apartment amenities" ON apartment_amenities;
...
-- Bookings policies
-- ============================================================
DROP POLICY IF EXISTS "Renters can view own bookings" ON bookings;
CREATE POLICY "Renters can view own bookings" ON bookings
  FOR SELECT USING (auth.uid() = renter_id);

DROP POLICY IF EXISTS "Landlords can view bookings for their apartments" ON bookings;
...
DROP POLICY IF EXISTS "Landlords can update bookings for their apartments" ON bookings;
...
-- Reviews policies
-- ============================================================
DROP POLICY IF EXISTS "Anyone can view reviews for approved apartments" ON reviews;
...
DROP POLICY IF EXISTS "Renters can create reviews for their bookings" ON reviews;
CREATE POLICY "Renters can create reviews for their bookings" ON reviews
  FOR INSERT WITH CHECK (auth.uid() = renter_id);

DROP POLICY IF EXISTS "Renters can update own reviews" ON reviews;
...
DROP POLICY IF EXISTS "Landlords can manage blocked dates for own apartments" ON blocked_dates;
